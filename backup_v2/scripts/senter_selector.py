...
class SenterSelector:
    ...
    def _init_components(self):
        ...
        # STUB: Embedding model not initialized
        # Without this, _embed_filter() just returns first N options
        # To enable semantic routing, uncomment and implement:
    ...
    def _embed_filter(self, query: str, options: List[str], max_options: int) -> List[str]:
        ...
        Currently just returns the first N options without any semantic filtering.
        This means routing is NOT semantic - it's essentially random/ordered selection.

        Future implementation would:
        - Generate embeddings for query and all options
        - Compute cosine similarity between query and options
        - Return top N most similar options
        - Requires: nomic-embed model loaded in self.embed_model
        ...
        Returns:
            Filtered list of options (currently just first N)
        """
        # STUB: No actual embedding similarity - just returns first N
